...
A non-app for testing saltstack deployment states
...
.. code-block:: bash
    ...
    cd dummy
    celery -A dummy.taskapp worker -l info
...
To run the tests, enter the dummy/tests directory and run the following commands::
